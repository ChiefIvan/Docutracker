...
class Flaskserver:
    ...
    def __init__(self):
        ...
        self.server.config["MAIL_SERVER"] = "smtp.gmail.com"
        self.server.config["MAIL_PORT"] = 465
        self.server.config["MAIL_USE_TLS"] = False
        self.server.config["MAIL_USE_SSL"] = True
